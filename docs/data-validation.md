...
- Two local contexts exercise both save orders for competing quantity writes and independent store relationship additions. Resetting both contexts observes the last local scalar save and the union of independent relationship additions. These are local merge-policy observations, not a whole-set last-writer guarantee for CloudKit relationships.
