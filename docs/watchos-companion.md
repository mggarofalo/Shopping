...
On September 24, 2026, the container was created and assigned to both app IDs on team `649367BDD4`. A signed Debug iPhone build with its embedded Watch app passed; inspection of both signatures confirmed the container, Development environment, CloudKit service and development push entitlement. Schema initialization, Production deployment and two-account device proof remain unverified.
